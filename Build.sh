#!/bin/sh
#
# CannyOS cannyos-user-desktop-gnome container build script
#
...
#
clear
curl https://raw.githubusercontent.com/intlabs/cannyos-user-desktop-gnome/master/CannyOS/CannyOS.splash
#     *****************************************************
#     *                                                   *
#     *        _____                    ____  ____        *
...
sudo docker build -t="intlabs/cannyos-user-desktop-gnome" github.com/intlabs/cannyos-user-desktop-gnome
...
sudo mkdir -p "/CannyOS/build/cannyos-user-desktop-gnome"
